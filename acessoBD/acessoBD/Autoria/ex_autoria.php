...
<body>
    <div class="container">
        <h2 class="text-center">Excluir Autoria</h2>
        <form id="excluirForm" method="POST" action="">
            <div class="form-group">
                <label for="autor">Informe o ID do Autor e do Livro da Autoria que deseja excluir:</label>
                <input type="text" class="form-control"  placeholder="ID do Autor" name="tAutor"  required>
                <br>
        ...
        if (isset($btnExcluir)) {
            ...
            $autoria = new Autoria();
            $autoria->setCodigo($tAutor);
            $autoria->setCodigoLivro($tLivro);
            echo "<h3><br><br>" . $autoria->exclusao() . "</h3>";
        }
        ?>
