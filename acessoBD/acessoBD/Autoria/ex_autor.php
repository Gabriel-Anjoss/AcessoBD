...
<body>
    <div class="container">
        <h2 class="text-center">Excluir Autor</h2>
        <form id="excluirForm" method="POST" action="">
            <div class="form-group">
                <label for="autor">Informe o ID do Autor que deseja excluir:</label>
                
                <input type="text" class="form-control"  placeholder="ID do Autor" name="txtid"  required>
            </div>
