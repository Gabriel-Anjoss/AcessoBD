    ...
    <div class="container">
        ...
        <form id="excluirForm" method="POST" action="">
            <div class="form-group">
                <label for="produto">Informe o ID do produto que deseja excluir:</label>
                <input type="text" class="form-control" id="produto" placeholder="ID do produto" name="produto" required>
            </div>
        ...
        <?php
            if (isset($_POST['btnExcluir'])) {
                ...
                $p = new Produto();
                $p->setId($produto);
                echo "<h3 class='text-center'><br><br>" . $p->exclusao() . "</h3>";
            }
        ?>
